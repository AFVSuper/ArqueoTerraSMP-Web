    ...
    <>
      ...
      <section className="py-20 sm:py-28">
        <div className="page-wrap">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between"><div><span className="eyebrow">Hemeroteca</span><h3 className="mt-4">Lugar donde se almacenan todos los periódicos emitidos</h3></div></div>
        </div>
      </section>
    </>
  );
